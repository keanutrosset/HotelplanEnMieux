      ...
      <form class="form" method='POST'>
          ...
          <div class="container" style="margin-top:50px; text-align: center">
              ...
              <tr>
                ...
                <th style="text-align: left"><label class="text-muted" for="userPsw"><h5>Mot de passe</h5></label></th>
                <td><input type="password" placeholder="Entrez votre mot de passe" name="inputUserPsw" required></td>

              </tr>
              <tr>
                <th style="text-align: left"><label class="text-muted" for="psw-repeat"><h5>Repetez le mot de passe</h5></label></th>
                <td><input type="password" placeholder="Repetez le mot de passe" name="inputUserPswRepeat" required></td>
              </tr>
